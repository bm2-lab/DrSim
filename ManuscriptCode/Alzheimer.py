...
p_value = 0.01  ### use 0.01 as the cutoff to classify the compound to be effective or ineffective
# output ranked drug repositioning result generated by DrSim
...
### output ranked drug repositioning result generated by other methods (GSEA, KS)
...
### using those signature as reference signatures
